		...
		<div class="wrapper">
			...
			?>
				...
				<?php
						...
						{
							?>
								<a href="pay.php?id=<?php echo $id;?>&price=<?php echo $rws['hire_cost'];?>">Click to Book</a>
							<?php
						}
				?>
				<?php
						if(isset($_POST['save'])){
							...
							VALUES('$fname','$id_no','$gender','$email','$phone','$location','$id','Pending')";
							$result = $conn->query($qry);
							if ($result === TRUE) {
    						$last_id = $conn->insert_id;
							}

							$qry1 = "INSERT INTO billing_information (client_id,car_id,price)
							VALUES('$last_id','$id',$price)";
